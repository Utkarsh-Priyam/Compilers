...
public class Main
{
    ...
    {
        FileInputStream fileInputStream = new FileInputStream(new File("jflextester.txt"));
        JFlexScanner scanner = new JFlexScanner(new InputStreamReader(fileInputStream));
